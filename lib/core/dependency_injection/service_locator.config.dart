...
import '../../feature/auth/domain/use_cases/clear_data_usecase.dart' as _i7;
...
import '../../feature/auth/presentation/bloc/clear_data/clear_data_bloc.dart'
    as _i9;
import '../../feature/auth/presentation/bloc/sign_up/signup_bloc.dart' as _i8;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i7.ClearDataUseCase>(
        () => _i7.ClearDataUseCase(authRepository: gh<_i4.IAuthRepository>()));
    gh.lazySingleton<_i8.SignUpBloc>(
        () => _i8.SignUpBloc(signUpUseCase: gh<_i6.SignUpUseCase>()));
    gh.lazySingleton<_i9.ClearDataBloc>(
        () => _i9.ClearDataBloc(clearDataUseCase: gh<_i7.ClearDataUseCase>()));
    return this;
  }
}
